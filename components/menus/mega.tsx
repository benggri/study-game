      ...
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        ...
        <div id="mega-menu" className={`items-center justify-between ${menuHidden ? 'hidden' : ''} w-full`}>
          <ul className="flex flex-col mt-4 font-medium">
            <li>
              <a className="cursor-pointer block py-2 pl-3 pr-4 text-blue-600 border-b border-gray-100 hover:bg-gray-50" aria-current="page">Home</a>
            </li>
            <li>
              <button id="mega-menu-dropdown-button" data-dropdown-toggle="mega-menu-dropdown" className="flex items-center justify-between w-full py-2 pl-3 pr-4 font-medium text-gray-900 border-b border-gray-100 hover:bg-gray-50">
                Company 
